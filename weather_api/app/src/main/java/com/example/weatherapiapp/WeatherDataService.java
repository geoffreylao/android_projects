...
public class WeatherDataService {
    ...
    public void getCityForecastByID(String cityID, ForecastByIDResponse forecastByIDResponse) {
        ...
        MySingleton.getInstance(context).addToRequestQueue(request);
                ...
                // get property consolidated weather


                // get each item in array and assign to WeatherReportModel object
    }
    ...
    public void getCityForecastByName(String cityName, GetCityForecaseByNameCallback getCityForecaseByNameCallback) {
            ...
            public void onResponse(String cityID) {
                ...
                getCityForecastByID(cityID, new ForecastByIDResponse() {
                    ...
                    public void onResponse(List<WeatherReportModel> weatherReportModels) {
                        ...
                        getCityForecaseByNameCallback.onResponse(weatherReportModels);
                    }
                });
            }
        });

        // fetch the city forecase given the city id
    }
}
